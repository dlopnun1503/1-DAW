...
(4, 'Organización',NULL, 30, 'New York' ),
(5, 'Desarrollo',NULL, 33, 'Memphis' );
...
(9, 'Mari','A','Spanish','453453431','1972-07-31','5631 Rice, New York, TX', 25000,3,3),
(10, 'Carlos','V','García','945987987','1969-08-06','980 Memphis, Houston, TX',35000,4,null),
(11, 'Pedro','E','Borg','778775555','1937-01-02','450 Carol, Houston, TX',55000,NULL,null);
...
UPDATE Departamentos SET jefe_departamento_id=5 WHERE id=4;
UPDATE Departamentos SET jefe_departamento_id=6 WHERE id=5;
...
(7, 'Telesférico Picos de Europa',30,'Gijón','2010/12/24','2018/12/24',4);
